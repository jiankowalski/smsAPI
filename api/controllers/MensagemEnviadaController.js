...
module.exports = {
  ...
  create: function(req, res) {
    ...
    MensagemEnviada.create(paramObj, function mensagemEnviadaCreated(err, mensagemEnviada) {
      ...
      res.redirect('/mensagemEnviada/show/' + mensagemEnviada.id);
  ...
  update: function(req, res, next) {
    ...
    MensagemEnviada.update(req.param('id'), paramObj, function mensagemEnviadaUpdated(err) {
      if (err) {
        ...
        return res.redirect('/mensagemEnviada/edit/' + req.param('id'));
      }

      res.redirect('/mensagemEnviada/show/' + req.param('id'));
    });
  },
